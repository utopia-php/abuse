...
Help us keep Utopia-php open and inclusive. Please read and follow our [Code of Conduct](https://github.com/utopia-php/abuse/blob/master/CODE_OF_CONDUCT.md).Make sure to read it before you start working.Any discrepancy found will not be tolerated.
...
If you are still having questions or doubts, you can ask questions to [Eldad Fux (@eldadfux)](https://twitter.com/eldadfux) or anyone from the [Appwrite team on Discord](https://discord.gg/GSeTUeA).
Happy:) contribution to Utopia-php.
